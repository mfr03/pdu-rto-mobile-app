...
class HiveService {
  ...
  static Future<Box<ParameterItem>> openParameterBox({required String wellApiToken}) async {
    final wellSpecificBoxName = '${_userParameters}_$wellApiToken';
    return await Hive.openBox<ParameterItem>(wellSpecificBoxName);
  }

  static Future<Box<ParameterItem>> openDepthParameterBox({required String wellApiToken}) async {
    final wellSpecificBoxName = '${_userParametersDepth}_$wellApiToken';
    return await Hive.openBox<ParameterItem>(wellSpecificBoxName);
  }
